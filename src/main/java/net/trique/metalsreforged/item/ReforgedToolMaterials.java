...
public enum ReforgedToolMaterials implements ToolMaterial {
    ...
    ReforgedToolMaterials(final TagKey<Block> inverseTag, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
